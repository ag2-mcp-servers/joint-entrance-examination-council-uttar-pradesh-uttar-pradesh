...
#   timestamp: 2025-06-28T15:08:51+00:00
...
class CertificateParameters(BaseModel):
    ApplicationNo: str = Field(..., description='ApplicationNo', examples=['2000001'])
    DOB: str = Field(
        ..., description='Date of birth in DD-MM-YYYY format', examples=['31-12-1980']
    )
    ExamYear: str = Field(..., description='Year of Examination', examples=['2018'])
